...
import (
	...
	"github.com/ajinkyak423/notifications-engine/pkg/templates"
...
//go:generate mockgen -destination=../mocks/api.go -package=mocks github.com/ajinkyak423/notifications-engine/pkg/api API
